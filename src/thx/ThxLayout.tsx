...
export const ThxLayout = () => {
    const clickSubmit = () => {
        window.gtag("event", "ok_click", {
            variant_name: "ghk_3508_ios_134_14_17_6",
        });
    };
  ...
  return (
    <>
      ...
      <div className={appSt.bottomBtn} onClick={clickSubmit}>
          <ButtonMobile block view="primary" href="cashline://multistep-route?fromModule=FORM&stepNumber=0&alias=alfa-subscription-alias">
              Хорошо
          </ButtonMobile>
      </div>
    </>
